...
const App = () => {
  ...
  const kaleidoscopeRef = useRef<any>(null);
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden" onPointerDown={(e) => kaleidoscopeRef.current?.handleAction(e)}>
      ...
      {!permissionGranted && (
        <div className="fixed inset-0 flex flex-col items-center justify-start pt-[15vh] p-8 text-center permission-overlay z-[100]">
          ...
          <div className="flex flex-col items-center gap-1 mt-auto mb-[15vh]">
            ...
            <p className="text-[12px] text-[#F15A2B] font-bold">핸드폰을 흔들거나 화면을 터치하세요</p>
          </div>
      ...
      {permissionGranted && (
        <div className="absolute inset-x-0 bottom-12 text-center pointer-events-none z-50">
           <p className="text-[10px] tracking-[0.4em] text-[#F15A2B]/60 font-bold uppercase animate-pulse">
             Shake or Touch
           </p>
        </div>
      )}
